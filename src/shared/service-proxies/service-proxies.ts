	...
	protected processSeacthUser(response: AxiosResponse): Promise<ZEngineResponse<ZUserInfoDto[]>> {
		...
		if (status === 200) {
			...
			if (Array.isArray(resultData200)) {
				result200 = [] as any;
				for (let item of resultData200) result200.push(ZUserInfoDto.fromJS(item));
			} else {
				result200 = <any>null;
			}
			result200Data = ZEngineResponse.fromJS(_responseText);
...
export class ServiceProxy {
	 ...
	 * @return Success
	 */
	edit(body: UpdateSysMenuInput | undefined, cancelToken?: CancelToken): Promise<ZEngineResponse<void>> {
	...
	protected processEdit(response: AxiosResponse): Promise<ZEngineResponse<void>> {
		const status = response.status;
		let _headers: any = {};
		if (response.headers && typeof response.headers === 'object') {
			for (let k in response.headers) {
...
export class TagssServiceProxy {
	...
	protected processSelect(response: AxiosResponse): Promise<ZEngineResponse<SelectOutput[]>> {
		...
		if (status === 200) {
			...
			if (Array.isArray(resultData200)) {
				result200 = [] as any;
				for (let item of resultData200) result200.push(SelectOutput.fromJS(item));
			} else {
				result200 = <any>null;
			}
			result200Data = ZEngineResponse.fromJS(_responseText);
...
export class UserSyssServiceProxy {
	...
	getPage(
	...
	): Promise<ZEngineResponse<UserPageOutputPageResult>> {
		...
		if (orgId === null) throw new Error("The parameter 'orgId' cannot be null.");
		else if (orgId !== undefined) url_ += 'OrgId=' + encodeURIComponent('' + orgId) + '&';
		if (mobile === null) throw new Error("The parameter 'mobile' cannot be null.");
		else if (mobile !== undefined) url_ += 'Mobile=' + encodeURIComponent('' + mobile) + '&';
		if (name === null) throw new Error("The parameter 'name' cannot be null.");
		else if (name !== undefined) url_ += 'Name=' + encodeURIComponent('' + name) + '&';
		if (pageNo === null) throw new Error("The parameter 'pageNo' cannot be null.");
		else if (pageNo !== undefined) url_ += 'PageNo=' + encodeURIComponent('' + pageNo) + '&';
...
export class RoleSyssServiceProxy {
	...
	getPage(
		...
		pageSize: number | undefined,
		cancelToken?: CancelToken
	): Promise<ZEngineResponse<RolePageOutputPageResult>> {
...
export class OrganizationSyssServiceProxy {
	...
	protected processGetPage(response: AxiosResponse): Promise<ZEngineResponse<SysOrgPageOutput[]>> {
		...
		if (status === 200) {
			...
			if (Array.isArray(resultData200)) {
				result200 = [] as any;
				for (let item of resultData200) result200.push(SysOrgPageOutput.fromJS(item));
			} else {
				result200 = <any>null;
			}
			result200Data = ZEngineResponse.fromJS(_responseText);
	...
	protected processTreeSelect(response: AxiosResponse): Promise<ZEngineResponse<TreeSelectOutput[]>> {
		...
		if (status === 200) {
			...
			if (Array.isArray(resultData200)) {
				result200 = [] as any;
				for (let item of resultData200) result200.push(TreeSelectOutput.fromJS(item));
			} else {
				result200 = <any>null;
			}
			result200Data = ZEngineResponse.fromJS(_responseText);
...
export class OAuthsServiceProxy {
	...
	protected processLinks(response: AxiosResponse): Promise<ZEngineResponse<FriendLinkOutput[]>> {
		...
		if (status === 200) {
			...
			if (Array.isArray(resultData200)) {
				result200 = [] as any;
				for (let item of resultData200) result200.push(FriendLinkOutput.fromJS(item));
			} else {
				result200 = <any>null;
			}
			result200Data = ZEngineResponse.fromJS(_responseText);
...
export class MenusServiceProxy {
	...
	protected processGetPage(response: AxiosResponse): Promise<ZEngineResponse<MenuPageOutput[]>> {
		...
		if (status === 200) {
			...
			if (Array.isArray(resultData200)) {
				result200 = [] as any;
				for (let item of resultData200) result200.push(MenuPageOutput.fromJS(item));
			} else {
				result200 = <any>null;
			}
			result200Data = ZEngineResponse.fromJS(_responseText);
	...
	protected processPermissionMenus(response: AxiosResponse): Promise<ZEngineResponse<RouterOutput[]>> {
		...
		if (status === 200) {
			...
			if (Array.isArray(resultData200)) {
				result200 = [] as any;
				for (let item of resultData200) result200.push(RouterOutput.fromJS(item));
			} else {
				result200 = <any>null;
			}
			result200Data = ZEngineResponse.fromJS(_responseText);
	...
	removeButton(menus: Menu[] | undefined, cancelToken?: CancelToken): Promise<ZEngineResponse<void>> {
		...
		if (menus === null) throw new Error("The parameter 'menus' cannot be null.");
...
export class ArticleCsServiceProxy {
	...
	protected processCategories(response: AxiosResponse): Promise<ZEngineResponse<CategoryOutput[]>> {
		...
		if (status === 200) {
			...
			if (Array.isArray(resultData200)) {
				result200 = [] as any;
				for (let item of resultData200) result200.push(CategoryOutput.fromJS(item));
			} else {
				result200 = <any>null;
			}
			result200Data = ZEngineResponse.fromJS(_responseText);
	...
	protected processLatest(response: AxiosResponse): Promise<ZEngineResponse<ArticleBasicsOutput[]>> {
		...
		if (status === 200) {
			...
			if (Array.isArray(resultData200)) {
				result200 = [] as any;
				for (let item of resultData200) result200.push(ArticleBasicsOutput.fromJS(item));
			} else {
				result200 = <any>null;
			}
			result200Data = ZEngineResponse.fromJS(_responseText);
	...
	protected processTags(response: AxiosResponse): Promise<ZEngineResponse<TagsOutput[]>> {
		...
		if (status === 200) {
			...
			if (Array.isArray(resultData200)) {
				result200 = [] as any;
				for (let item of resultData200) result200.push(TagsOutput.fromJS(item));
			} else {
				result200 = <any>null;
			}
			result200Data = ZEngineResponse.fromJS(_responseText);
...
export class AlbumsCsServiceProxy {
	...
	pictures(
		...
		pageSize: number | undefined,
		cancelToken?: CancelToken
	): Promise<ZEngineResponse<PictureOutputPageResult>> {
		let url_ = this.baseUrl + '/api/AlbumsCs/Pictures?';
		if (albumId === null) throw new Error("The parameter 'albumId' cannot be null.");
		else if (albumId !== undefined) url_ += 'AlbumId=' + encodeURIComponent('' + albumId) + '&';
		if (pageNo === null) throw new Error("The parameter 'pageNo' cannot be null.");
		else if (pageNo !== undefined) url_ += 'PageNo=' + encodeURIComponent('' + pageNo) + '&';
		if (pageSize === null) throw new Error("The parameter 'pageSize' cannot be null.");
		else if (pageSize !== undefined) url_ += 'PageSize=' + encodeURIComponent('' + pageSize) + '&';
...
export class AddRoleInput implements IAddRoleInput {
	...
	init(_data?: any) {
		if (_data) {
			...
			if (Array.isArray(_data['menus'])) {
				this.menus = [] as any;
				for (let item of _data['menus']) this.menus.push(item);
			}
		}
	}
	...
	toJSON(data?: any) {
		...
		if (Array.isArray(this.menus)) {
			data['menus'] = [];
			for (let item of this.menus) data['menus'].push(item);
		}
		return data;
	}
	...
	init(_data?: any) {
		if (_data) {
			...
			if (Array.isArray(_data['rows'])) {
				this.rows = [] as any;
				for (let item of _data['rows']) this.rows.push(AlbumsOutput.fromJS(item));
			}
		}
	}
...
export class AlbumsPageOutputPageResult implements IAlbumsPageOutputPageResult {
	...
	init(_data?: any) {
		if (_data) {
			...
			if (Array.isArray(_data['rows'])) {
				this.rows = [] as any;
				for (let item of _data['rows']) this.rows.push(AlbumsPageOutput.fromJS(item));
			}
		}
	}
...
export class ArticleInfoOutput implements IArticleInfoOutput {
	...
	init(_data?: any) {
		if (_data) {
			...
			if (Array.isArray(_data['random'])) {
				this.random = [] as any;
				for (let item of _data['random']) this.random.push(ArticleBasicsOutput.fromJS(item));
			}
			if (Array.isArray(_data['tags'])) {
				this.tags = [] as any;
				for (let item of _data['tags']) this.tags.push(TagsOutput.fromJS(item));
			}
		}
	}
	...
	toJSON(data?: any) {
		...
		if (Array.isArray(this.random)) {
			data['random'] = [];
			for (let item of this.random) data['random'].push(item.toJSON());
		}
		if (Array.isArray(this.tags)) {
			data['tags'] = [];
...
export class ArticleOutputPageResult implements IArticleOutputPageResult {
	...
	init(_data?: any) {
		if (_data) {
			...
			if (Array.isArray(_data['rows'])) {
				this.rows = [] as any;
				for (let item of _data['rows']) this.rows.push(ArticleOutput.fromJS(item));
			}
		}
	}
...
export class ArticlePageOutputPageResult implements IArticlePageOutputPageResult {
	...
	init(_data?: any) {
		if (_data) {
			...
			if (Array.isArray(_data['rows'])) {
				this.rows = [] as any;
				for (let item of _data['rows']) this.rows.push(ArticlePageOutput.fromJS(item));
			}
		}
	}
		...
		if (_data) {
			...
			if (_data['covers']) {
				...
				for (let key in _data['covers']) {
					if (_data['covers'].hasOwnProperty(key)) (<any>this.covers)[key] = _data['covers'][key] !== undefined ? _data['covers'][key] : [];
				}
			}
		}
	}
	...
	toJSON(data?: any) {
		...
		if (this.covers) {
			...
			for (let key in this.covers) {
				if (this.covers.hasOwnProperty(key)) (<any>data['covers'])[key] = (<any>this.covers)[key];
			}
		}
		return data;
	}
...
export class CommentOutputPageResult implements ICommentOutputPageResult {
	...
	init(_data?: any) {
		if (_data) {
			...
			if (Array.isArray(_data['rows'])) {
				this.rows = [] as any;
				for (let item of _data['rows']) this.rows.push(CommentOutput.fromJS(item));
			}
		}
	}
...
export class FriendLinkPageOutputPageResult implements IFriendLinkPageOutputPageResult {
	...
	init(_data?: any) {
		if (_data) {
			...
			if (Array.isArray(_data['rows'])) {
				this.rows = [] as any;
				for (let item of _data['rows']) this.rows.push(FriendLinkPageOutput.fromJS(item));
			}
		}
	}
...
export class Menu implements IMenu {
	...
	init(_data?: any) {
		if (_data) {
			...
			this.deleteMark = _data['deleteMark'];
			this.createdTime = _data['createdTime'] ? moment(_data['createdTime'].toString()) : <any>undefined;
			if (Array.isArray(_data['children'])) {
				this.children = [] as any;
				for (let item of _data['children']) this.children.push(Menu.fromJS(item));
			}
		}
	}
...
export class MenuPageOutput implements IMenuPageOutput {
	...
	init(_data?: any) {
		if (_data) {
			...
			if (Array.isArray(_data['children'])) {
				this.children = [] as any;
				for (let item of _data['children']) this.children.push(MenuPageOutput.fromJS(item));
			}
		}
	}
...
export class ObjectPageResult implements IObjectPageResult {
	...
	init(_data?: any) {
		if (_data) {
			...
			if (Array.isArray(_data['rows'])) {
				this.rows = [] as any;
				for (let item of _data['rows']) this.rows.push(item);
			}
		}
	}
...
export class PictureOutputPageResult implements IPictureOutputPageResult {
	...
	init(_data?: any) {
		if (_data) {
			...
			if (Array.isArray(_data['rows'])) {
				this.rows = [] as any;
				for (let item of _data['rows']) this.rows.push(PictureOutput.fromJS(item));
			}
		}
	}
...
export class ReplyOutputPageResult implements IReplyOutputPageResult {
	...
	init(_data?: any) {
		if (_data) {
			...
			if (Array.isArray(_data['rows'])) {
				this.rows = [] as any;
				for (let item of _data['rows']) this.rows.push(ReplyOutput.fromJS(item));
			}
		}
	}
...
export class RolePageOutputPageResult implements IRolePageOutputPageResult {
	...
	init(_data?: any) {
		if (_data) {
			...
			if (Array.isArray(_data['rows'])) {
				this.rows = [] as any;
				for (let item of _data['rows']) this.rows.push(RolePageOutput.fromJS(item));
			}
		}
	}
...
export class RouterOutput implements IRouterOutput {
	...
	init(_data?: any) {
		if (_data) {
			...
			if (Array.isArray(_data['children'])) {
				this.children = [] as any;
				for (let item of _data['children']) this.children.push(RouterOutput.fromJS(item));
			}
		}
	}
...
export class SysOrgPageOutput implements ISysOrgPageOutput {
	...
	init(_data?: any) {
		if (_data) {
			...
			if (Array.isArray(_data['children'])) {
				this.children = [] as any;
				for (let item of _data['children']) this.children.push(SysOrgPageOutput.fromJS(item));
			}
		}
	}
...
export class TagsPageOutputPageResult implements ITagsPageOutputPageResult {
	...
	init(_data?: any) {
		if (_data) {
			...
			if (Array.isArray(_data['rows'])) {
				this.rows = [] as any;
				for (let item of _data['rows']) this.rows.push(TagsPageOutput.fromJS(item));
			}
		}
	}
...
export class TalksOutputPageResult implements ITalksOutputPageResult {
	...
	init(_data?: any) {
		if (_data) {
			...
			if (Array.isArray(_data['rows'])) {
				this.rows = [] as any;
				for (let item of _data['rows']) this.rows.push(TalksOutput.fromJS(item));
			}
		}
	}
...
export class TalksPageOutputPageResult implements ITalksPageOutputPageResult {
	...
	init(_data?: any) {
		if (_data) {
			...
			if (Array.isArray(_data['rows'])) {
				this.rows = [] as any;
				for (let item of _data['rows']) this.rows.push(TalksPageOutput.fromJS(item));
			}
		}
	}
...
export class TreeSelectOutput implements ITreeSelectOutput {
	...
	init(_data?: any) {
		if (_data) {
			...
			if (Array.isArray(_data['children'])) {
				this.children = [] as any;
				for (let item of _data['children']) this.children.push(TreeSelectOutput.fromJS(item));
			}
		}
	}
...
export class UserInfoOutput implements IUserInfoOutput {
	...
	init(_data?: any) {
		if (_data) {
			...
			if (Array.isArray(_data['authBtnList'])) {
				...
				for (let item of _data['authBtnList']) this.authBtnList.push(item);
			}
		}
	}
	...
	toJSON(data?: any) {
		...
		if (Array.isArray(this.authBtnList)) {
			data['authBtnList'] = [];
			for (let item of this.authBtnList) data['authBtnList'].push(item);
		}
		return data;
	}
...
export class UserPageOutputPageResult implements IUserPageOutputPageResult {
	...
	init(_data?: any) {
		if (_data) {
			...
			if (Array.isArray(_data['rows'])) {
				this.rows = [] as any;
				for (let item of _data['rows']) this.rows.push(UserPageOutput.fromJS(item));
			}
		}
	}
